...
import 'package:spacex/features/rocket_details/pages/widgets/rocket_details/article.dart';
import 'package:spacex/features/rocket_details/pages/widgets/rocket_details/info_section.dart';
import 'package:spacex/features/rocket_details/pages/widgets/rocket_details/photos_section.dart';

class RocketSecondaryDetails extends StatelessWidget {
  const RocketSecondaryDetails({super.key, required this.rocket});
    ...
    return Column(
      ...
      children: [
        ...
        InfoSection(
          ...
          subtitle: "${NumberFormat("#,##0").format(rocket.costPerLaunch)} USD",
          subtitleColor: MyColors.white,
        ),
